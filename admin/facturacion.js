...
document.addEventListener(
  ...
  function () {
    ...
    function abrirConfig() {
      ...
      els.configModal.style.display =
        "flex";

      els.configModal.setAttribute(
        "aria-hidden",
        "false"
      );
        ...
        async function (event) {
          ...
          if (
            ...
            try {
              ...
              if (
                ...
                partialErrors.push(
                  "la URL del backend debe usar http o https"
                );
              }
            } catch (_) {
              partialErrors.push(
                "la URL del backend no es válida"
              );
            }
          }
          ...
          try {
            ...
            if (
              ...
              mensajeConfig(
                "Backend guardado localmente. Firestore no permitió guardar "
                +
                "la configuración completa todavía: "
                +
                (
                  error.message ||
                  "error de Firestore"
    ...
    function abrirRide(
      ...
      if (!opened) {
        alert(
          "El navegador bloqueó la ventana del RIDE. Permite ventanas emergentes para localhost y vuelve a intentarlo."
        );
      }
    }
